                     ...
                     <h2 class="text-center">Edit Category</h2>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtUpdateCatName" CssClass="form-control bg-white" runat="server"></asp:TextBox>
                            </div>

                        </div>
                        <div class="d-grid mt-4">
                        <asp:Button ID="btnUpdateBrand" CssClass="btn btn-danger" runat="server" Text="UPDATE" OnClick="btnUpdateBrand_Click" />
                        </div>
